...
for (meas_location_iter in beaco2n_site_list) {
    ...
    # Data structures
    df_list = list(
        ext      = arrange_plot_df(co, "co", "beaco2n", meas_location_iter, FALSE, "aqs", ref_location),
        ext_met  = arrange_plot_df(co_met, "co", "beaco2n", meas_location_iter, FALSE, "aqs", ref_location),
