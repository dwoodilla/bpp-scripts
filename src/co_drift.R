...
deployment_correlation(
    ...
    season_data = co_unfiltered_plottable_extref,
    filepath="./plots/co_drift/myron/extref/deployment_correlation_nofilter.png",
...
divergence_line_plot(
    ...
    filepath="./plots/co_drift/myron/extref/divergence_line_plot_nofilter.png",
...
png(filename="./plots/co_drift/myron/extref/divergence_table_nofilter.png", width=8.5, height=11, units="in", res=300)
grid.table(
...
deployment_correlation(
    ...
    season_data=co_filtered_plottable_extref,
    filepath="./plots/co_drift/myron/extref/deployment_correlation_metfilter.png",
    title="Deployment Time Series Correlation by Operating Month",
    subtitle="Myron BEACO2N vs. Myron RIDEM",
...
deployment_density(
    season_data=co_filtered_plottable_extref,
    filepath="./plots/co_drift/myron/extref/deployment_pdfs_metfilter.png",
    title="Deployment Probability Density Functions by Operating Month",
    subtitle="Myron BEACO2N vs. Myron RIDEM", 
    caption="meteorology=(t<30C, rh<0.75)  noise=\"original\"",
    x="[CO] (ppm)",
...
divergence_line_plot(
    ...
    filepath="./plots/co_drift/myron/extref/divergence_line_plot_metfilter.png",
    title="Divergence Statistics over Months Deployed",
    subtitle="Myron BEACO2N vs. Myron RIDEM",
    caption="meteorology=(t<30C, rh<0.75)  noise=\"original\"",
    x="Months Deployed",
...
png(filename="./plots/co_drift/myron/extref/divergence_table_metfilter.png", width=8.5, height=11, units="in", res=300)
grid.table(
...
deployment_correlation(
    ...
    season_data = co_unfiltered_plottable_intref,
    filepath="./plots/co_drift/myron/intref/deployment_correlation_nofilter.png",
    title="Deployment Time Series Correlation by Operating Month",
    subtitle="Myron BEACO2N vs. Myron BEACO2N at Operating-year 1",
    caption="meteorology=(no filter)  noise=\"original\"",
    x="Reference [CO] (ppm)",
    y="Measurement [CO] (ppm)"
)
deployment_density(
    season_data=co_unfiltered_plottable_intref,
    filepath="./plots/co_drift/myron/intref/deployment_pdfs_nofilter.png",
    title="Deployment Probability Density Functions by Operating Month",
    subtitle="Myron BEACO2N vs. Myron BEACO2N at Operating-year 1",
    caption="meteorology=(no filter)  noise=\"original\"",
    x="[CO] (ppm)",
...
divergence_line_plot(
    ...
    filepath="./plots/co_drift/myron/intref/divergence_line_plot_nofilter.png",
    title="Divergence Statistics over Months Deployed",
    subtitle="Myron BEACO2N vs. Myron BEACO2N at Operating-year 1",
    caption="meteorology=(no filter)  noise=\"original\"",
    x="Months Deployed",
...
png(filename="./plots/co_drift/myron/intref/divergence_table_nofilter.png", width=8.5, height=11, units="in", res=300)
grid.table(
...
deployment_correlation(
    ...
    season_data = co_filtered_plottable_intref,
    filepath="./plots/co_drift/myron/intref/deployment_correlation_metfilter.png",
    title="Deployment Time Series Correlation by Operating Month",
    subtitle="Myron BEACO2N vs. Myron BEACO2N at Operating-year 1",
    caption="meteorology=(t<30C, rh<0.75)  noise=\"original\"",
    x="Reference [CO] (ppm)",
...
deployment_density(
    season_data=co_filtered_plottable_intref,
    filepath="./plots/co_drift/myron/intref/deployment_pdfs_metfilter.png",
    title="Deployment Probability Density Functions by Operating Month",
    subtitle="Myron BEACO2N vs. Myron BEACO2N at Operating-year 1",
    caption="meteorology=(t<30C, rh<0.75)  noise=\"original\"",
    x="[CO] (ppm)",
...
divergence_line_plot(
    ...
    filepath="./plots/co_drift/myron/intref/divergence_line_plot_metfilter.png",
    title="Divergence Statistics over Months Deployed",
    subtitle="Myron BEACO2N vs. Myron BEACO2N at Operating-year 1",
    caption="meteorology=(t<30C, rh<0.75)  noise=\"original\"",
    x="Months Deployed",
...
png(filename="./plots/co_drift/myron/intref/divergence_table_metfilter.png", width=8.5, height=11, units="in", res=300)
grid.table(
...
divergence_line_plot(
    ...
    filepath="./plots/co_drift/myron/extref/metfilter_divergence_difference.png",
    lims_y=c(-0.33,0.33),
    self_ref=FALSE,
...
divergence_line_plot(
    ...
    filepath="./plots/co_drift/myron/intref/metfilter_divergence_difference.png",
    lims_y=c(-0.33,0.33),
    self_ref=FALSE,
    title="Change in Divergence after Meteorological Filtering",
